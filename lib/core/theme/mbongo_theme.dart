...
class MbongoThemeController {
  ...
  static const List<MbongoThemePalette> palettes = [
    ...
    MbongoThemePalette(
      ...
      name: 'Fintech Night',
      shortLabel: 'Night',
      description: 'Fond sombre intense avec accent rouge premium.',
      shellTop: Color(0xFF1A0808),
      shellBottom: Color(0xFF0D0303),
      panel: Color(0xFF1E0A0A),
      panelAlt: Color(0xFF240D0D),
      accent: Color(0xFFE63946),
      accentStrong: Color(0xFFC0152A),
      glow: Color(0x66E63946),
      bannerGradient: [Color(0xFF5C1010), Color(0xFF2A0505), Color(0xFFE63946)],
      cardGradient: [Color(0xFF4A0A0A), Color(0xFF200505)],
    ),
    MbongoThemePalette(
      id: 'royal',
      name: 'Royal Gold',
  ...
  static const List<MbongoThemePalette> lightPalettes = [
    ...
    MbongoThemePalette(
      ...
      name: 'Fintech Light',
      shortLabel: 'Rouge',
      description: 'Version claire avec accent rouge vif.',
      shellTop: Color(0xFFFFF5F5),
      shellBottom: Color(0xFFFFECEC),
      panel: Color(0xFFFFFFFF),
      panelAlt: Color(0xFFFFFFFF),
      accent: Color(0xFFD32F2F),
      accentStrong: Color(0xFF9B0000),
      glow: Color(0x33D32F2F),
      bannerGradient: [Color(0xFF9B0000), Color(0xFFD32F2F), Color(0xFFEF5350)],
      cardGradient: [Color(0xFF9B0000), Color(0xFF7B0000)],
    ),
    MbongoThemePalette(
      id: 'royal',
      name: 'Royal Light',
