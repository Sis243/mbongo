...
let WalletController = class WalletController {
    ...
    getByUser(_userId, user) {
        return this.walletService.getWalletSummary(user.userId);
    }
    getLedger(_userId, user) {
        return this.walletService.getWalletLedger(user.userId);
    }
};
...
], WalletController.prototype, "getMine", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], WalletController.prototype, "getMyLedger", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], WalletController.prototype, "getByUser", null);
__decorate([
